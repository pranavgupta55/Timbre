...
import { MobileWorkspaceNav } from "@/components/layout/WorkspaceNav";
...
export default function ReelPage() {
  ...
  return (
    <div className="scrollbar-none flex min-h-dvh min-w-0 flex-col overflow-x-hidden xl:h-full xl:min-h-0 xl:overflow-y-auto">
      <div className="border-b border-border-light/60 bg-bg-base/84 backdrop-blur-xl xl:hidden">
        <MobileWorkspaceNav className="px-4 py-2 sm:px-6" />
      </div>

      <div className="flex min-w-0 flex-1 flex-col gap-4 px-4 py-4 sm:px-6 sm:py-5 xl:px-0 xl:pt-0 xl:pb-[calc(10rem+env(safe-area-inset-bottom))]">
        ...
        <div className="grid min-w-0 gap-4 xl:min-h-0 xl:flex-1 xl:grid-cols-[minmax(0,1fr)_320px]">
          <div className="min-w-0 space-y-4 xl:min-h-0 xl:space-y-0">
            ...
            <section className="editor-surface flex min-w-0 flex-col overflow-hidden rounded-[32px] p-4 sm:p-5 xl:min-h-0">
              <div className="flex flex-col gap-3 border-b border-white/10 pb-4 sm:flex-row sm:items-center sm:justify-between">
                ...
                <label className="hidden w-full min-w-0 items-center gap-3 rounded-full border border-white/10 bg-white/[0.04] px-4 py-3 sm:flex sm:max-w-[320px]">
              ...
              {isLoading ? (
                ...
                <div className="scrollbar-none mt-4 min-w-0 xl:min-h-0 xl:flex-1 xl:overflow-y-auto xl:pr-1">
                    ...
                    {filteredTracks.map((track, index) => {
                      ...
                      return (
                        <div
                          ...
                          className={cn(
                            "min-w-0 overflow-hidden rounded-[24px] border px-4 py-3.5 transition-all sm:rounded-[26px] sm:px-5 sm:py-4",
                            isActive
                        ...
                        >
                          <div className="flex min-w-0 items-center gap-3">
                            <div className="min-w-0 flex-1">
                              <div className="truncate font-sans text-sm text-text-main sm:text-[15px]">{track.title}</div>
                            </div>
        ...
        <div className="h-[calc(20rem+env(safe-area-inset-bottom))] shrink-0 xl:hidden" aria-hidden="true" />
      </div>
    </div>
  );
}
