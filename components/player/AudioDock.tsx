...
function TransportShell({
  ...
  return (
    <div className="pointer-events-none fixed inset-x-0 bottom-0 z-50 px-4 pb-0 sm:px-6 lg:px-6">
      <div className="mx-auto w-full max-w-[1480px]">
        <div className="pointer-events-auto rounded-t-[30px] rounded-b-none border border-b-0 border-white/10 bg-[linear-gradient(180deg,rgba(10,10,11,0.92),rgba(17,17,16,0.82))] px-4 pt-3 pb-[calc(0.75rem+env(safe-area-inset-bottom))] shadow-[0_30px_120px_rgba(0,0,0,0.44)] backdrop-blur-2xl sm:px-5 sm:pt-3.5 sm:pb-[calc(0.875rem+env(safe-area-inset-bottom))]">
